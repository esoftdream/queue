...
class QueueWork extends BaseCommand
{
    ...
    {
        if ($payloadMetadata === null || ! $payloadMetadata->hasChainedJobs()) {
            return;
        }
    ...
    {
        if ($payloadMetadata === null || ! $payloadMetadata->has('taskLockTTL') || ! $payloadMetadata->has('taskLockKey')) {
            return;
        }
    ...
    {
        if ($payloadMetadata === null || ! $payloadMetadata->has('taskLockKey')) {
            return;
        }
